export const SQL_CREATE =
  'CREATE TABLE IF NOT EXISTS Todos ( todoId INTEGER PRIMARY KEY, todo VARCHAR(100) NOT NULL, comments TEXT, completed BOOLEAN NOT NULL, userId VARCHAR(100) NOT NULL )';
